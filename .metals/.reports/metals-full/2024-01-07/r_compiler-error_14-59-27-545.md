...
public abstract class Product {
    ...
    private int supplierId;//todo maybe change to the class
    private Stock stock;//todo mirar la clase stock MAP(?)
    ...
    public void updateProduct(String change) {
        Scanner newinfo = new Scanner(System.in);
        if (change == ("supplierId")) {
            this.supplierId = newinfo.nextInt();
            newinfo.nextLine();
        }
