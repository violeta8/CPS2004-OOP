            ...
            case 1:
                ...
                switch(choice1) {
                    case 1:
                        ...
                        System.out.println( "Ple@@ase enter the customer's warehouse distance" );
                        double warehouseDistance = scanner.nextDouble();
                        Customer customer = new Customer(name, address, email, phone, warehouseDistance);
                        customerRep.saveCustomer(customer);
                        System.out.println( "Would you like to add another customer? Please write yes" );
                        scanner.nextLine();
