file:///C:/Users/viole/Desktop/ERASMUS/cps2004-oop-1/application/src/main/java/project/App.java
...
action parameters:
offset: 34614
uri: file:///C:/Users/viole/Desktop/ERASMUS/cps2004-oop-1/application/src/main/java/project/App.java
text:
```scala
package project;
    ...
    public static void ShipmentMenu(){
        ...
        switch (choice6) {
            case 1:
                ...
                int i=0;
                do{
                    System.out.println("Please enter the id and the quantity of the products you want to add to the shipmen@@t");
