...
public class Customer {
	...
	public boolean equals(Customer customer) {
        return this.nam@@e.equals(customer.name) && this.address.equals(customer.address) && this.email.equals(customer.email) && this.phone.equals(customer.phone) && this.warehouseDistance == customer.warehouseDistance;
    }
