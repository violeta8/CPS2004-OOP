...
Clothing::Clothing(int id, double price, std::string colour)
      : Product(id, price), colour_(colour){}
...
TShirt::TShirt(int id, double price, std::string color, std::string size)
        : Clothing(id, price, color), size_(size){}
...
Pants::Pants(int id, double price, std::string color, std::string shop)
        : Clothing(id, price, color), shop_(shop){}
