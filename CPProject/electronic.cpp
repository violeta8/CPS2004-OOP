...
Electronic::Electronic(int id, double price, std::string brand) 
...
Smartphone::Smartphone(int id, double price, std::string brand, std::string os)
        : Electronic(id, price, brand), operatingSystem_(os){}
...
Tablet::Tablet(int id, double price, std::string brand, std::string model)
        : Electronic(id, price, brand), model_(model){}
